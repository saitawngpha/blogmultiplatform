...
import com.saitawngpha.blogmultiplatform.util.Constants.DATABASE_NAME
import com.saitawngpha.blogmultiplatform.util.Constants.MAIN_POST_LIMIT
...
class MongoDB(private val context: InitApiContext): MongoRepository {
    ...
    private val client = KMongo.createClient(System.getenv("MONGO_URI"))
