...
import com.saitawngpha.blogmultiplatform.styles.LoginInputStyle
...
import com.saitawngpha.blogmultiplatform.util.checkUserExistence
                    ...
                    .onClick {
                        scope.launch {
                            ...
                            if(username.isNotEmpty() && password.isNotEmpty()){
                                ...
                                if (user != null){
                                    rememberUserLoggedIn(remember = true, user = user)
                                ...
                                errorText = "Input feilds are empty."
                                delay(3000)
                                errorText = " "
                            }
...
private fun rememberUserLoggedIn(
    remember: Boolean, user: UserWithoutPass? = null
)
{
