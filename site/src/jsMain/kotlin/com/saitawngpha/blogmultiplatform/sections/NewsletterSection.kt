...
import com.saitawngpha.blogmultiplatform.styles.NewsletterInputStyle
...
import com.saitawngpha.blogmultiplatform.util.subscribeToNewsletter
import com.saitawngpha.blogmultiplatform.util.validateEmail
...
fun NewsletterSection(
    ...
    Box (
        modifier = Modifier
            .fillMaxWidth()
            .margin(bottom = 250.px, top = 35.px)
